const char LS_HELP[] PROGMEM = "LIST FILES";
const char CAT_HELP[]PROGMEM = "SHOW FILE DATA";
const char RM_HELP[]PROGMEM = "REMOVE FILES";
const char PS_HELP[]PROGMEM = "PROCESS STATUS";
const char KILL_HELP[]PROGMEM = "KILL PROCESS";
const char DUMP_HELP[]PROGMEM = "SHOW VM MEMORIES";
const char STOP_HELP[]PROGMEM = "STOP THE VM RIGHT NOW";
const char INPUT_HELP[]PROGMEM = "SWITCH TO INTERACTIVE MODE";
const char PMOD_HELP[]PROGMEM = "SET PIN MODE, 0 INPUT,1 OUTPUT,2 PULLUP";
const char DREAD_HELP[]PROGMEM = "DIGITAL READ";
const char DWRITE_HELP[]PROGMEM = "DIGITAL WRITE";
const char AREAD_HELP[]PROGMEM = "ANALOG READ";
const char AWRITE_HELP[]PROGMEM = "ANALOG WRITE";
